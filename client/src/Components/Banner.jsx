...
const Banner = () => {
    ...
    return (
        <div className="bg-[#ECF0F2] pb-6 md:py-0 dark:bg-[#183336]">
                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex gap-12 flex-col-reverse lg:flex-row">
                        <div className='lg:w-1/2'>
                            <p className='font-semibold rounded-md text-primary dark:text-[#2f8675] inline px-4'>Welcome To dreamMate</p>
                            ...
                            <p className="mt-6 !text-[18px] font-secondary !leading-[26px] text-Description dark:text-Description2 sm:text-xl">Join dreamMate and find your ideal partner. Connect with people who share your values and interests. Start your journey to lasting love today!</p>
                        ...
                        <div className='lg:w-1/2 py-8 relative gap-6 flex'>
                            ...
                            <motion.div
                                initial={{ opacity: 1, y: 50, x: mobile ? 90 : 250, scale: mobile ? 0.8 : 1 }}
                                animate={{ opacity: 1, y: 50, x: mobile ? 100 : 280, scale: mobile ? 0.8 : 1 }}
                                transition={{ duration: 3, repeat: Infinity, repeatType: 'reverse' }}
                                className='absolute'>
                                <img className='w-[150px]' src="https://templates.hibotheme.com/wazo/default/assets/img/hero/hero-shape-2.png" alt="" />
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 1, y: 350, x: -100, scale: mobile ? 0.8 : 1 }}
                                animate={{ opacity: 1, y: 280, x: -70, scale: mobile ? 0.8 : 1 }}
