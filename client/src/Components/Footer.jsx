...
import logo from '/heart-crack-solid.png'
...
const Footer = () => {
    ...
    return (
        <div className='mt-12 pt-24 pb-6 relative bg-[#ECF0F2] dark:bg-[#183235]'>
            <div className=' px-10 lg:px-20 flex flex-col lg:flex-row gap-8'>
                ...
                <div className="lg:w-[400px]">
                    <a href="#" title="" className="flex gap-2 items-center">
                        ...
                        <p className=' font-semibold text-heading dark:text-heading2 text-3xl'>dreamMate</p>
                    </a>
                    <p className='mt-4 text-xl font-light dark:text-Description2'>Your Journey to Love Starts Here with dreamMate</p>
            ...
            <p className='font-light mt-4  dark:text-Description2 text-center py-4'>Copyright © 2024. <a href='#' className='underline cursor-pointer'>dreamMate.com</a> All rights reserved.</p>
        </div>
    );
};
